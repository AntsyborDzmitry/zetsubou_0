<%@page session="false" trimDirectiveWhitespaces="true" contentType="text/html;charset=utf-8" import="com.day.cq.i18n.I18n" %>
    ...
    <tr>
        <td align="center" valign="top">
            <table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="border-collapse: collapse;">
                ...
                <tr>
                    <td align="left" style="padding: 5px; padding-top: 50px; padding-bottom: 50px">
