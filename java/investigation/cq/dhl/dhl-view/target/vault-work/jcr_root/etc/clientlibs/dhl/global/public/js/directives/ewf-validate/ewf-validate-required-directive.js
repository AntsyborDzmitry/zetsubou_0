define(['exports', 'module', 'ewf', './../../validation/validators-factory'], function (exports, module, _ewf, _validationValidatorsFactory) {
    ...
    module.exports = ewfValidateRequired;
    ...
    _ewf2['default'].directive('ewfValidateRequired', ewfValidateRequired);

    function ewfValidateRequired(validatorsFactory) {
        return {
            restrict: 'A',
            require: ['ewfInput'],
            link: {
...
//# sourceMappingURL=ewf-validate-required-directive.js.map
