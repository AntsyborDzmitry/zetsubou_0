define(['exports', 'module', './base-validator'], function (exports, module, _baseValidator) {
    ...
    var MaxValidator = (function (_BaseValidator) {
        _inherits(MaxValidator, _BaseValidator);

        function MaxValidator(options) {
            _classCallCheck(this, MaxValidator);

            _get(Object.getPrototypeOf(MaxValidator.prototype), 'constructor', this).call(this, options);
