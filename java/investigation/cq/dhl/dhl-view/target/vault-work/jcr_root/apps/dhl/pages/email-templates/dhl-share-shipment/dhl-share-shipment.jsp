            ...
            <table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="border-collapse: collapse;">
                ...
                <tr>
                    <td align="left" style="padding: 5px;">
                        <cq:include path="header" resourceType="foundation/components/text"/>
                    </td>
                </tr>
                <tr>
                    <td align="left" style="padding: 5px;">
                        <!-- TODO: add trackingNumber, label, pickupConfirmationNumber, receipt, customsInvoice -->
                        <div>
                         $msg
                        ...
                        #if($pickupNumber)
                            <br>Pickup confirmation number: $pickupNumber
                        #end
    
                        </div>
                        <div>
                            <cq:include path="footer" resourceType="foundation/components/text"/>
                        </div>
                    </td>
                </tr>
                <tr>
                    <td align="right" valign="top" bgcolor="#dbdbdb" style="padding: 5px 2px 2px 0;color: #666;">
