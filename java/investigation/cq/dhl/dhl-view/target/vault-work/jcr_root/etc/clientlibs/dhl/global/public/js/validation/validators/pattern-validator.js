define(['exports', 'module', './base-validator'], function (exports, module, _baseValidator) {
    ...
    var PatternValidator = (function (_BaseValidator) {
        _inherits(PatternValidator, _BaseValidator);

        function PatternValidator(options) {
            _classCallCheck(this, PatternValidator);

            _get(Object.getPrototypeOf(PatternValidator.prototype), 'constructor', this).call(this, options);
        ...
        _createClass(PatternValidator, [{
            ...
            key: 'wrapRegexp',
            value: function wrapRegexp(regex) {
