...
public class ShapeActivator implements BundleActivator {
    ...
    public void start(BundleContext bundleContext) throws Exception {
        ...
        ResourceBundle resourceBundle = ResourceBundle.getBundle("com.zetsubou_0.osgi.figure.Localize");
        Dictionary<String, Object> dictionary = new Hashtable<>();
        dictionary.put(Figure.NAME, resourceBundle.getString(CIRCLE_NAME));
