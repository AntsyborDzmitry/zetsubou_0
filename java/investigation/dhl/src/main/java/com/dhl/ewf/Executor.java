...
public class Executor implements Closeable {
    ...
    public Executor(PropertyReader properties) {
        if (properties == null) {
            return;
        }
    ...
    public void setPropertyReader(final PropertyReader propertyReader) {
    ...
    public String executeQuery(final Map<String, String> queryParams) throws IOException {
        ...
        uriBuilder.setScheme(properties.getScheme()).setHost(properties.getHost()).setPath(QUERY_BUILDER_PATH);
