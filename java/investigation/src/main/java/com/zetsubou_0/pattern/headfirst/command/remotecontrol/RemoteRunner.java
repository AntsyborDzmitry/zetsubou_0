package com.zetsubou_0.pattern.headfirst.command.remotecontrol;

import com.zetsubou_0.pattern.headfirst.command.remotecontrol.command.LightOffControl;
import com.zetsubou_0.pattern.headfirst.command.remotecontrol.command.LightOnControl;
import com.zetsubou_0.pattern.headfirst.command.remotecontrol.device.Light;
import com.zetsubou_0.pattern.headfirst.command.remotecontrol.remotedevice.RemoteControlDevice;
