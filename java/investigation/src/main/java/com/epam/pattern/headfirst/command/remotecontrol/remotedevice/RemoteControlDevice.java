package com.epam.pattern.headfirst.command.remotecontrol.remotedevice;

import com.epam.pattern.headfirst.command.remotecontrol.command.Command;
import com.epam.pattern.headfirst.command.remotecontrol.command.EmptyCommand;
